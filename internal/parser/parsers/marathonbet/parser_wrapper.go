...
func init() {
	parsers.Register("marathonbet", func(cfg *config.Config) parsers.Parser {
...
// StartIncremental implements interfaces.IncrementalParser (one full ParseOnce per cycle).
