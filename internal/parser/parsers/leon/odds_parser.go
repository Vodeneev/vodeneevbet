...
// Фолы: только маркеты по матчу (тотал/кто больше/фора). Индивидуальные (по игроку 1970324837126376, по команде 1970324837126390) не парсим —
// дают одинаковый parameter "15+" без привязки к команде, путают line movement и value bets.
var foulsMainMarketTypeIDs = map[int64]bool{
	// TODO: добавить marketTypeId тотала фолов, кто больше фолов, форы по фолам, когда появятся в API
}
