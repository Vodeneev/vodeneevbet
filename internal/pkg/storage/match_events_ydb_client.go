...
// HierarchicalYDBClient provides YDB operations for hierarchical match data
type HierarchicalYDBClient struct {
	db     ydb.Connection
	config *config.YDBConfig
}

// NewHierarchicalYDBClient creates a new YDB client for match events
func NewHierarchicalYDBClient(cfg *config.YDBConfig) (*HierarchicalYDBClient, error) {
...
func (y *HierarchicalYDBClient) StoreMatch(ctx context.Context, match *models.Match) error {
...
func (y *HierarchicalYDBClient) storeMatchMetadata(ctx context.Context, match *models.Match) error {
...
func (y *HierarchicalYDBClient) storeEvent(ctx context.Context, matchID string, event *models.Event) error {
...
func (y *HierarchicalYDBClient) storeEventMetadata(ctx context.Context, matchID string, event *models.Event) error {
	return y.db.Table().Do(ctx,
		func(ctx context.Context, s table.Session) error {
			_, _, err := s.Execute(ctx, table.TxControl(
				table.BeginTx(table.WithSerializableReadWrite()),
...
func (y *HierarchicalYDBClient) storeOutcome(ctx context.Context, eventID string, outcome *models.Outcome) error {
	return y.db.Table().Do(ctx,
		func(ctx context.Context, s table.Session) error {
			_, _, err := s.Execute(ctx, table.TxControl(
				table.BeginTx(table.WithSerializableReadWrite()),
...
func (y *HierarchicalYDBClient) GetMatch(ctx context.Context, matchID string) (*models.Match, error) {
...
func (y *HierarchicalYDBClient) getMatchMetadata(ctx context.Context, matchID string) (*models.Match, error) {
...
func (y *HierarchicalYDBClient) getEventsForMatch(ctx context.Context, matchID string) ([]models.Event, error) {
...
func (y *HierarchicalYDBClient) getOutcomesForEvent(ctx context.Context, eventID string) ([]models.Outcome, error) {
...
func (y *HierarchicalYDBClient) GetAllMatches(ctx context.Context) ([]models.Match, error) {
...
func (y *HierarchicalYDBClient) createTablesIfNotExist(ctx context.Context) error {
	return y.db.Table().Do(ctx,
		func(ctx context.Context, s table.Session) error {
...
func (y *HierarchicalYDBClient) Close() error {
