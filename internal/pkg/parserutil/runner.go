...
// For incremental parsing, matches are not cleared at cycle start - new matches
// update existing ones via mergeMatchInto, ensuring data remains available during processing
